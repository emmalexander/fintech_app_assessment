...
<svg viewBox="0 0 40 30" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M10 0 L10 30 M30 0 L30 30 M0 15 L40 15 M15 0 L15 10 M25 0 L25 10 M15 30 L15 20 M25 30 L25 20" stroke="#B8860B" stroke-width="1.5" fill="none"/>
</svg>''';

  static const String contactless = '''
<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
  <path d="M8.5 21.3c-1.3-2.6-2-5.4-2-8.3s.7-5.7 2-8.3"/>
  <path d="M12.5 19.3c-.9-2.1-1.5-4.4-1.5-6.8s.6-4.7 1.5-6.8"/>
  <path d="M16.5 16.8c-.5-1.4-.8-2.9-.8-4.3s.3-2.9.8-4.3"/>
</svg>''';
...
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M9 21h6M12 15v6M7 7h1M11 7h6"/>
</svg>''';

  static const String wallet = '''
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
  <path d="M21 12V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5z"/>
  <path d="M21 12H16v-2h5v2z"/>
</svg>''';
...
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
  ...
  static const String eStatement = '''
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
...
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
  <path d="M4 5h16M9 3v2M12 5c0 5-4 9-4 9M19 5s-2 5-6 8M15 15l-2 5M17 15l2 5M14 17h4"/>
</svg>''';
...
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
  <path d="M12 2v20M2 12h20M19 5l-14 14M5 5l14 14M16 12l3-3M16 12l3 3M8 12l-3-3M8 12l-3 3M12 8l3-3M12 8l-3-3M12 16l3 3M12 16l-3 3M16 16l3 3M16 8l3-3M8 16l-3 3M8 8l-3-3"/>
</svg>''';
